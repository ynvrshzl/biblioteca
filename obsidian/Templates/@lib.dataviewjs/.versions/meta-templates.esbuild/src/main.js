...
const templates = {
    ...
    "project": async function () {
        ...
        await dv.view("Components/Section", { Text: "README.md", Open: 1, Body: dv.el('section', (self.description ?? "No description")) })
        await dv.view("Components/Documents");
        await dv.view("Components/Section", { Text: "Sub-projects", Body: null })
